0 TEXT:PRINT CHR$(21):HOME:GOTO 80
1 IF AZ THEN U=AUX:V=SPC:W=SPC:REM ALT ZP
2 VTAB Y:HTAB  7:? B$(U);:HTAB 18:? B$(V);:HTAB 29:? B$(W);:RETURN:REM COLS RW/R/W
3 IF RR OR RW THEN U=SPC:REM AUX MEM
4 V=RAM:IF RR THEN V=AUX
5 W=RAM:IF RW THEN W=AUX
6 RETURN
7 IF S8 AND P2 THEN U=AUX:R=AUX:W=AUX
8 GOSUB 2:RETURN
...
590 GOSUB 2
600 REM *** LOWER 48K
610 Y= 7:U=RAM:V=SPC:W=SPC:GOSUB 3:GOSUB 2:REM $BFFF
620 Y= 9:U=RAM:V=SPC:W=SPC:GOSUB 3:GOSUB 2:REM $4000
630 Y=11:U=RAM:V=SPC:W=SPC:GOSUB 3:GOSUB 7:REM $2000
640 Y=13:U=RAM:V=SPC:W=SPC:GOSUB 3:GOSUB 2:REM $0C00

0 TEXT:PRINT CHR$(21):HOME:PRINT "v5":GOTO 80
...
90 COL=5:D=COL*2:N=COL*3:M=21:B=13:DIM K(D),T$(D*2),H(D),S(D),B$(B+1),A$(M),U(M)
100 REM *** STATUS LINE
110 FOR I=1 TO D:READ KEY$,T$(I),H(I):K(I)=ASC(KEY$):NEXT:FOR I=1 TO D:READ T$(I+D):NEXT
120 REM *** BANKS
130 FOR I=0 TO B:READ B$(I):NEXT
140 REM *** MEMORY
...
430 IF X=2 THEN U=RLC:V=SPC:W=SPC:IF AZ THEN U=U+1
...
550 IF Z=4 THEN U=RV2:V=SPC:W=SPC:IF AZ THEN U=U-4
560 IF Z=5 THEN U=RU1:V=SPC:W=SPC:IF AZ THEN U=U-4
...
850 REM *** BANK
860 DATA " *"        :REM B$(0)
870 DATA "          ":REM B$(1)  SPC
880 DATA "__________":REM B$(2)
890 DATA "          ":REM B$(3)
900 DATA "__________":REM B$(4)
910 DATA "    AUX   ":REM B$(5)
920 DATA "  AUX B1  ":REM B$(6)
930 DATA "  AUX B2  ":REM B$(7)
940 DATA "    RAM   ":REM B$(8)  RAM
950 DATA "    ROM   ":REM B$(9)  ROM
960 DATA "  RAM B1  ":REM B$(10  RU1
970 DATA "  RAM B2  ":REM B$(11  RV2
980 DATA "  RAM L/C ":REM B$(12) RLC
990 DATA "  AUX L/C ":REM B$(13)
